...
if(isset($_POST['reservation_email'])){
		...
		$subject = "Reservation Requested From Website";
		$body = "New reservation requested from the Bardot website
<br><br>
...
if(!empty($_POST['date']) && !empty($_POST['time']) && !empty($_POST['party'])){	
