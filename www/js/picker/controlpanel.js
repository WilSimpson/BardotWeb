...
for(var i=1; i<= 15; i++){
	...
	$patterns += '<img src="../../../../js/picker/'+ $img +'" alt="pattern'+i+'" title="pattern'+i+'"/>'
	$patterns += '</a>';
	$patterns += '</li>'; 
}
...
for(var i=0; i<$color.length; i++){
	...
	$colors += '<img src="../../../../js/picker/'+ $img +'" alt="color-'+$color[i]+'" title="color-'+$color[i]+'"/>'
	$colors += '</a>';
	$colors += '</li>'; 
}
...
jQuery(document).ready(function(){
	...
	if($.cookie("mytheme_layout") == "boxed"){
		...
		jQuery("link[id='responsive-css']").after('<link id="boxed-css" href="../../../../js/picker/boxed.css" rel="stylesheet" type="text/css" media="all" />');
